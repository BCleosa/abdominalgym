...
const floorPhotos = {
  "Lantai 1": [
    ...
    { src: "/gallery/lt1-6.jpg", caption: "Alat Lantai 1" },
  ],
  "Lantai 2": [
  ...
  "Lantai 3": [
    ...
    { src: "/gallery/lt3-6.jpg", caption: "Alat Lantai 3" },
  ],
};
    ...
    <section id="gallery" style={{ background: "#0a0a0a", padding: isMobile ? "40px 0 30px" : "50px 0 40px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 20px" }}>
        ...
        <div>
            ...
            {floorPhotos[activeFloor].map((photo, i) => (
              ...
              >
                ...
                <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#333", pointerEvents: "none" }}>
                  ...
                  <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.58rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "#333" }}>
                    {activeFloor} · {i + 1}
                  </div>
                </div>
              </div>
          ...
          {/* Info */}
          <p style={{ marginTop: 14, fontSize: "0.75rem", color: "#333", fontWeight: 300 }}>
            Simpan foto ke <code style={{ color: "#555", background: "#1a1a1a", padding: "1px 6px", borderRadius: 3 }}>public/gallery/</code> → <code style={{ color: "#555", background: "#1a1a1a", padding: "1px 6px", borderRadius: 3 }}>lt1-1.jpg</code>, <code style={{ color: "#555", background: "#1a1a1a", padding: "1px 6px", borderRadius: 3 }}>lt2-1.jpg</code>, dst.
          </p>
        </div>
      </div>
