...
const testimonials = [
  { name: "Rizky Pratama", since: "Member sejak Sep 2024", rating: 5, comment: "Tempatnya nyaman banget, alatnya lengkap dan terawat. Pelatihnya juga sabar dan profesional. Udah 3 bulan latihan di sini, hasilnya keliatan banget!" },
  { name: "Sari Dewi", since: "Member sejak Okt 2024", rating: 5, comment: "Seneng banget ada pelatih wanita, jadi lebih nyaman latihannya. Elia orangnya ramah dan programnya disesuaikan sama tujuan aku. Recommended!" },
  { name: "Budi Santoso", since: "Member sejak Ags 2024", rating: 5, comment: "Gym pertama yang buka di Kudus dengan fasilitas selengkap ini. Harganya juga terjangkau, worth it banget buat investasi kesehatan." },
  { name: "Ayu Rahayu", since: "Member sejak Nov 2024", rating: 5, comment: "Lokasinya strategis, parkiran luas, dan suasananya bikin semangat latihan. Staff nya juga ramah-ramah. Pokoknya top deh!" },
  ...
  { name: "Andi Wijaya", since: "Member sejak Jan 2025", rating: 5, comment: "Abdominal Gym beda dari gym lain. Bersih, nyaman, dan pelatihnya beneran ngerti kebutuhan member. Highly recommended!" },
];
